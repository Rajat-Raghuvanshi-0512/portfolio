...
const Skills = () => {
  ...
  return (
    <div className="pt-20 md:pt-20 px-5 lg:px-28 md:h-screen -z-50 bg-cover bg-center bg-white dark:bg-gradient-to-bl from-black to-slate-800 dark:saturate-50 dark:backdrop-saturate-150 dark:backdrop-brightness-75 overflow-hidden">
      <h2
        ref={headingref}
        className={`${
