...
var _secrets2 = require("../actions/secrets");
...
var MuxVideoPreview = _ref => {
  ...
  (0, _react.useEffect)(() => void (0, _secrets2.fetchSecrets)().then(_ref2 => {
    var _secrets = _ref2.secrets;
    return setSecrets(_secrets);
  }), []);
  var asset = (0, _react.useMemo)(() => {
    ...
    return {
      ...
      data: {
        playback_ids: value.playbackIds
      }
    };
  }, [value]);
  if (asset && secrets) {
    return /*#__PURE__*/_react.default.createElement(_VideoSource.VideoThumbnail, {
      asset: asset,
      secrets: secrets,
      width: 640
    });
